            ...
            <div>
              <header class="max-w-xl mb-7 mt-5">
                <h2 class="text-gray-800 text-lg font-semibold dark:text-gray-200">
                  {{ __('Edit Asset Categorie') }}
                </h2>
                <p class="text-sm text-gray-700 dark:text-gray-300">
                  {{ __('The process of editing Asset Categorie in a system or app.') }}
                </p>
              </header>
            </div>
            <form class="max-w-xl" action="{{ route('assetcategorie.update', $assetcategorie->id) }}" method="POST">
              @csrf
              @method('PUT')
              <div class="mt-6">
                <label for="name" class="block mb-1.5 text-sm text-gray-800 dark:text-gray-200">Name</label>
                <input type="text" id="name" name="name" value="{{ old('name', $assetcategorie->name) }}" class="dark:bg-gray-700 text-sm w-10/12 text-gray-700 dark:text-gray-200 py-2 border-b-2 border-gray-400/30 dark:border-gray-600/30 border-b-gray-400 dark:border-b-gray-500 rounded focus:ring-0 focus:border-t-gray-400/30 focus:border-b-2 focus:border-b-sky-600 dark:focus:border-b-gray-200 focus:border-x-gray-400/30" required>
              ...
              <div class="mt-6">
                ...
                <textarea name="description" id="description" rows="4" class="dark:bg-gray-700 text-sm w-10/12 text-gray-700 dark:text-gray-200 py-2 border-b-2 border-gray-400/30 dark:border-gray-600/30 border-b-gray-400 dark:border-b-gray-500 rounded focus:ring-0 focus:border-t-gray-400/30 focus:border-b-2 focus:border-b-sky-600 dark:focus:border-b-gray-200 focus:border-x-gray-400/30" required>{{ old('description', $assetcategorie->description) }}</textarea>
