          ...
          <section>
            ...
            <header class="max-w-xl mb-7 mt-5">
              ...
              <p class="text-sm text-gray-700 dark:text-gray-300">
                {{ __('The process of editing location in a system or app.') }}
              </p>
            </header>
              ...
              <div class="max-w-xl">
                ...
                <div class="mt-6">
                  ...
                  <select name="area_id" id="area_id" class="dark:bg-gray-700 text-sm w-7/12 text-gray-700 dark:text-gray-200 py-2 border-b-2 border-gray-400/30 dark:border-gray-600/30 border-b-gray-400 dark:border-b-gray-500 rounded focus:ring-0 focus:border-t-gray-400/30 focus:border-b-2 focus:border-b-sky-600 dark:focus:border-b-gray-200 focus:border-x-gray-400/30" required>
                    ...
                    <option {{ $location->area->id === $area->id ? 'selected' : '' }} value="{{ $area->id }}">{{ $area->name }}</option>
                    @empty
                      ----
                    @endforelse
                  </select>
                ...
                <div class="mt-6">
                  ...
                  <input type="text" id="name" name="name" value="{{ old('name', $location->name) }}" class="dark:bg-gray-700 text-sm w-8/12 text-gray-700 dark:text-gray-200 py-2 border-b-2 border-gray-400/30 dark:border-gray-600/30 border-b-gray-400 dark:border-b-gray-500 rounded focus:ring-0 focus:border-t-gray-400/30 focus:border-b-2 focus:border-b-sky-600 dark:focus:border-b-gray-200 focus:border-x-gray-400/30" required>
                ...
                <div class="mt-6">
                  ...
                  <textarea name="description" id="description" rows="4" class="dark:bg-gray-700 text-sm w-11/12 text-gray-700 dark:text-gray-200 py-2 border-b-2 border-gray-400/30 dark:border-gray-600/30 border-b-gray-400 dark:border-b-gray-500 rounded focus:ring-0 focus:border-t-gray-400/30 focus:border-b-2 focus:border-b-sky-600 dark:focus:border-b-gray-200 focus:border-x-gray-400/30" required>{{ old('description', $location->description) }}</textarea>
