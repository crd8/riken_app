          ...
          <section>
            ...
            <form action="{{ route('user.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-2 text-sm">
                  @forelse ($departments as $department)
                    <div class="flex bg-gray-200 dark:bg-gray-600 p-2 rounded items-center">
                      <label>
                        <input class="w-4 h-4 mb-1 text-sky-600 bg-gray-200 border-gray-500 rounded-xl text-xl focus:ring-sky-500 dark:focus:ring-sky-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-900 dark:border-gray-600" type="radio" name="department_id" value="{{ $department->id }}">
              ...
              <div class="mt-6">
                ...
                <select name="roles" id="role" class="dark:bg-gray-700 text-sm w-7/12 text-gray-700 dark:text-gray-200 py-2 border-b-2 border-gray-400/30 dark:border-gray-600/30 border-b-gray-400 dark:border-b-gray-500 rounded focus:ring-0 focus:border-t-gray-400/30 focus:border-b-2 focus:border-b-sky-600 dark:focus:border-b-gray-200 focus:border-x-gray-400/30">
                  <option value=""></option>
                ...
                <div class="grid grid-cols-2 gap-2 text-sm">
                  @forelse ($roles as $role)
                    <div class="flex bg-gray-200 dark:bg-gray-600 p-2 rounded items-center">
                      <label>
                        <input class="w-4 h-4 mb-1 text-sky-600 bg-gray-100 border-gray-300 rounded-xl focus:ring-sky-500 dark:focus:ring-sky-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="radio" name="roles[]" value="{{ $role->name }}"> 
                        <span class="capitalize text-gray-800">
                          {{ $role->name }}
                        </span>
                      </label>
