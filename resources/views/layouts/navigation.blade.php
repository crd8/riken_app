...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <div class="flex items-center md:order-2">
    <button id="theme-toggle" type="button" class="mr-4 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
      <svg id="theme-toggle-dark-icon" class="hidden w-5 h-5 text-sky-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
      <svg id="theme-toggle-light-icon" class="hidden w-5 h-5 text-sky-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
    </button>
...
<div id="drawer-navigation" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-64 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
  ...
  <div class="py-4 overflow-y-auto">
    <ul class="space-y-2 font-medium">
      ...
      <li>
        <button type="button" class="{{ request()->routeIs('permission.index', 'permission.create', 'permission.edit', 'role.index', 'role.create', 'role.edit', 'user.index', 'user.create', 'user.edit') ? 'flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group bg-sky-700 dark:bg-sky-600 hover:bg-sky-700 dark:text-white dark:hover:bg-sky-600' : 'flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' }}" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
          <svg class="{{ request()->routeIs('permission.index', 'permission.create', 'permission.edit', 'role.index', 'role.create', 'role.edit', 'user.index', 'user.create', 'user.edit') ? 'flex-shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-white dark:text-white dark:group-hover:text-white' : 'flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
        ...
        <ul id="dropdown-example" class="hidden py-2 space-y-2">
          ...
          <li>
            <a href="{{ route('role.index') }}" class="{{ request()->routeIs('role.index', 'role.create', 'role.edit') ? 'flex items-center w-full p-2 text-sky-700 transition duration-75 rounded-lg pl-11 group dark:text-sky-600 pointer-events-none' : 'flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' }}">
              {{ __('Roles') }}
            </a>
          </li>
          <li>
            <a href="{{ route('user.index') }}" class="{{ request()->routeIs('user.index') ? 'flex items-center w-full p-2 text-sky-700 transition duration-75 rounded-lg pl-11 group dark:text-sky-600 pointer-events-none' : 'flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' }}">
              {{ __('Users') }}
            </a>
          </li>
        </ul>
      ...
      <li>
        <a href="#" class="{{ request()->routeIs('department') ? 'flex items-center p-2 text-white rounded-lg dark:text-white bg-sky-700 dark:bg-sky-600 hover:bg-sky-700 dark:hover:bg-sky-600 group pointer-events-none' : 'flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group' }} ">
