    ...
    <ul class="space-y-2">
      ...
      <li>
        ...
        <ul id="dropdown-asset" class="hidden py-2 space-y-2">
          ...
          <li>
            <a href="{{ route('asset.index') }}" class="{{ request()->routeIs('asset.index', 'asset.create') ? 'flex items-center w-full p-2 text-sky-700 transition duration-75 rounded-lg pl-10 group dark:text-sky-600 pointer-events-none' : 'flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-10 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' }}">
              {{ __('Assets') }}
            </a>
            <a href="{{ route('assetcategorie.index') }}" class="{{ request()->routeIs('assetcategorie.index', 'assetcategorie.create', 'assetcategorie.edit', 'assetcategorie.trash') ? 'flex items-center w-full p-2 text-sky-700 transition duration-75 rounded-lg pl-10 group dark:text-sky-600 pointer-events-none' : 'flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-10 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' }}">
              {{ __('Categories') }}
            </a>
          </li>
          @endcan
