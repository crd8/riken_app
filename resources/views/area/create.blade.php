          ...
          <section>
            ...
            <form class="max-w-xl" action="{{ route('area.store') }}" method="POST">
              ...
              <div class="mt-6">
                ...
                <textarea name="address" id="address" rows="4" class="dark:bg-gray-700 text-sm w-10/12 text-gray-700 dark:text-gray-200 py-2 border-b-2 border-gray-400/30 dark:border-gray-600/30 border-b-gray-400 dark:border-b-gray-500 rounded focus:ring-0 focus:border-t-gray-400/30 focus:border-b-2 focus:border-b-sky-600 dark:focus:border-b-gray-200 focus:border-x-gray-400/30" required>{{ old('address') }}</textarea>
