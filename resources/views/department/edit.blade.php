        ...
        <div class="p-8 text-gray-900 dark:text-gray-200">
          <section>
            ...
            <div>
              <header class="max-w-xl mb-7 mt-5">
                ...
                <p class="text-sm text-gray-700 dark:text-gray-300">
                  {{ __('The process of editing department in a system or app.') }}
                </p>
              </header>
            </div>
            <form class="max-w-xl" action="{{ route('department.update', $department->id) }}" method="POST">
              ...
              @method('PUT')
              <div class="mt-6">
                <label for="code" class="block mb-1.5 text-sm text-gray-800 dark:text-gray-200">Department Code</label>
                <input type="text" id="code" name="code" value="{{ old('code', $department->code) }}" class="dark:bg-gray-700 text-sm w-8/12 text-gray-700 dark:text-gray-200 py-2 border-b-2 border-gray-400/30 dark:border-gray-600/30 border-b-gray-400 dark:border-b-gray-500 rounded focus:ring-0 focus:border-t-gray-400/30 focus:border-b-2 focus:border-b-sky-600 dark:focus:border-b-gray-200 focus:border-x-gray-400/30" required autofocus>
              ...
              <div class="mt-6">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $department->name) }}" class="dark:bg-gray-700 text-sm w-8/12 text-gray-700 dark:text-gray-200 py-2 border-b-2 border-gray-400/30 dark:border-gray-600/30 border-b-gray-400 dark:border-b-gray-500 rounded focus:ring-0 focus:border-t-gray-400/30 focus:border-b-2 focus:border-b-sky-600 dark:focus:border-b-gray-200 focus:border-x-gray-400/30" required>
