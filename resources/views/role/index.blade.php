                ...
                <tbody>
                  ...
                  <tr class="bg-gray-100 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="flex items-center px-6 py-4 space-x-3">
                      <a href="{{ route('role.show', $role->id) }}" class="hover:underline">
                        {{ __('Show') }}
                      </a>
                      @canany(['role edit', 'role delete'])
                        <a href="{{ route('role.edit', $role->id) }}" class="hover:underline">
                          {{ __('Edit') }}
                        </a>
                        <button class="hover:underline" data-modal-toggle="popup-modal{{ $role->id }}" data-modal-target="popup-modal{{ $role->id }}">
                          {{ __('Delete') }}
                        </button>
                      @endcanany
                    </td>
